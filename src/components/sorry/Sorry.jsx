...
function Sorry() {
  ...
  return (
    <div className='sorry-container1'>
      ...
      <p className='sorry-text'>Regardless, please feel free to contact us, and we'll go the extra mile to find the right service provider from our network for you</p>
